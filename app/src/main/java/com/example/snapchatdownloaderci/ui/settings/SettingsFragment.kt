package com.example.snapchatdownloaderci.ui.settings
...
import com.example.snapchatdownloaderci.NavActivity
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import androidx.work.WorkManager
import androidx.work.workDataOf
import com.example.snapchatdownloaderci.work.UpdateYoutubeDLWorker
    ...
    private fun updateYoutubeDL(updateChannelPreference: String){
        ...
        updateScope.launch {
            try {
                ...
                val workTag = "snapchat_update_worker"
